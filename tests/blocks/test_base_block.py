...
from src.sdg_hub.utils.error_handling import (
    MissingColumnError,
    EmptyDatasetError,
...
class TestBaseBlockInitialization:
    ...
    def test_properties_are_immutable(self):
        ...
        block = TestBlock("test_block", input_cols=["col1", "col2"])
    ...
    def test_repr(self):
        ...
        expected = "TestBlock(name='test_block', input_cols=['input'], output_cols=['output'])"
...
class TestColumnNormalization:
    ...
    def test_normalize_invalid_type(self):
        ...
        with pytest.raises(ValueError, match="Invalid column specification.*Must be str, List\\[str\\], or None"):
...
class TestValidation:
    ...
    def test_validate_columns_success(self):
        ...
        block = TestBlock("test_block", input_cols=["input", "category"])
    ...
    def test_validate_columns_no_input_cols(self):
        ...
        dataset = self.create_test_dataset()
        block = TestBlock("test_block")  # No input_cols specified
    ...
    def test_validate_columns_missing(self):
        ...
        dataset = self.create_test_dataset()
        block = TestBlock("test_block", input_cols=["input", "missing_col"])
    ...
    def test_validate_output_columns_success(self):
        ...
        dataset = self.create_test_dataset()
        block = TestBlock("test_block", output_cols=["new_col"])
    ...
    def test_validate_output_columns_no_output_cols(self):
        ...
        dataset = self.create_test_dataset()
        block = TestBlock("test_block")  # No output_cols specified
    ...
    def test_validate_output_columns_collision(self):
        ...
        dataset = self.create_test_dataset()
        block = TestBlock("test_block", output_cols=["input", "new_col"])  # "input" already exists
    ...
    def test_validate_dataset_fails_on_missing_columns(self):
        ...
        dataset = self.create_test_dataset()
        block = TestBlock("test_block", input_cols=["missing_col"])
    ...
    def test_validate_dataset_fails_on_column_collision(self):
        ...
        dataset = self.create_test_dataset()
        block = TestBlock("test_block", output_cols=["input"])
...
class TestLogging:
    ...
    @patch('src.sdg_hub.blocks.base.console')
...
class TestCallMethod:
    ...
    def test_call_column_collision(self, mock_console):
        ...
        dataset = self.create_test_dataset()
        block = TestBlock("test_block", output_cols=["input"])  # Collision with existing column
...
class TestGetInfo:
    ...
    def test_get_info_no_columns(self):
        ...
        assert info["block_type"] == "TestBlock"
...
class TestEdgeCases:
    ...
    def test_unicode_column_names(self):
        ...
        block = TestBlock("test_block", input_cols=["测试", "カテゴリ"])
