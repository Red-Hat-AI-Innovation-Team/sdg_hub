...
class TestCompositeBlockParameterForwarding:
    ...
    def test_meaningful_defaults_are_provided(self, mock_config):
        ...
        assert verify_block.text_parser.start_tags == [
            "[Start of Explanation]",
            "[Start of Rating]",
        ]
        ...
        assert (
            relevancy_block.filter_value == 2.0
