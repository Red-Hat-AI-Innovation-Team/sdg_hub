...
# Local
from src.sdg_hub.flow.checkpointer import FlowCheckpointer
...
class TestFlowCheckpointer:
    ...
    def test_find_remaining_samples_no_common_columns(self):
        ...
        remaining = checkpointer._find_remaining_samples(input_dataset, completed_dataset)
