...
class TestResolveEnvVariable:
    ...
    def test_resolve_non_env_value(self):
        ...
        from api_server import resolve_env_variable
...
class TestSlugifyName:
    ...
    def test_slugify_empty(self):
        ...
        from api_server import slugify_name
        result = slugify_name("")
...
class TestEnsureWithinDirectory:
    ...
    def test_path_within_directory(self):
        ...
        from api_server import ensure_within_directory
...
class TestGetCheckpointInfo:
    ...
    def test_get_checkpoint_info_no_directory(self):
        ...
        from api_server import get_checkpoint_info
        with tempfile.TemporaryDirectory() as temp_dir:
            with patch("api_server.CHECKPOINTS_DIR", Path(temp_dir)):
    ...
    def test_clear_checkpoints_no_directory(self):
        ...
        from api_server import clear_checkpoints
        with tempfile.TemporaryDirectory() as temp_dir:
            with patch("api_server.CHECKPOINTS_DIR", Path(temp_dir)):
