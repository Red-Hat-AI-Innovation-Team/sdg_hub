  ...
  describe('datasetAPI', () => {
    describe('uploadFile', () => {
      it('should upload a file', async () => {
        mockAxios.post.mockResolvedValueOnce({
          data: { status: 'success', file_path: 'uploads/test.jsonl' },
        });
    ...
    describe('loadDataset', () => {
      it('should load dataset', async () => {
        mockAxios.post.mockResolvedValueOnce({
          data: {
            status: 'success',
            dataset_info: { num_samples: 100, columns: ['input', 'output'] },
          },
        });
        ...
        expect(result.status).toBe('success');
        expect(result.dataset_info.num_samples).toBe(100);
      });
    });
  ...
  describe('executionAPI', () => {
    describe('dryRun', () => {
      it('should perform dry run', async () => {
        mockAxios.post.mockResolvedValueOnce({
          data: { flow_name: 'Test Flow', execution_successful: true },
        });
        ...
        expect(result.execution_successful).toBe(true);
      });
    });
