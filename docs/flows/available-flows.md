...
**Purpose:** Generate realistic Q&A pairs for RAG evaluation using In-Context Learning (ICL) with real user question examples, producing user-like questions instead of textbook-style ones.
