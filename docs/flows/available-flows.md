...
**Purpose:** Generate realistic Q&A pairs for RAG evaluation using the existing 3-stage question generation pipeline with ICL-driven question generation.

**Location:** `src/sdg_hub/flows/evaluation/rag_evaluation_icl/`

### Architecture

**3-Stage Pipeline with ICL Question Generation:**
