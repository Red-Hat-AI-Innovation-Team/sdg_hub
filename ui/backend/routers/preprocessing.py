        ...
        for part in parts:
            ...
            if 'name="files"' in headers_str or 'name="file"' in headers_str:
                ...
                if filename_match:
                    ...
                    # 2. sanitize_filename strips to [A-Za-z0-9_.-] only
                    # 3. re.fullmatch validates against allowlist (Snyk-recognized sanitizer)
...
async def chunk_markdown_documents(job_id: str, config: ChunkingConfig):
    ...
    try:
        ...
        for md_file in files_to_process:
            ...
            # Reconstruct path from trusted base + sanitized filename to break taint chain
